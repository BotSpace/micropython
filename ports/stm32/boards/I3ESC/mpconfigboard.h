#define MICROPY_HW_BOARD_NAME       "I3ESC"
#define MICROPY_HW_MCU_NAME         "STM32G431"

#define MICROPY_HW_ENABLE_RTC       (1)
#define MICROPY_HW_ENABLE_RNG       (1)
#define MICROPY_HW_ENABLE_ADC       (1)
#define MICROPY_HW_ENABLE_DAC       (1) // A4, A5
#define MICROPY_HW_ENABLE_USB       (1) // can be enabled if USB cable connected to PA11/PA12 (D-/D+) JMOD
...
// UART config
//#define MICROPY_HW_LPUART1_TX       (pin_A2)  // C1, A2, B11    JMOD
//#define MICROPY_HW_LPUART1_RX       (pin_A3)  // C0, A3, B10    JMOD
...
#define MICROPY_HW_USRSW_PIN        (pin_A0) //TEMP_2
#define MICROPY_HW_USRSW_PULL       (GPIO_PULLUP)
#define MICROPY_HW_USRSW_EXTI_MODE  (GPIO_MODE_IT_FALLING)
#define MICROPY_HW_USRSW_PRESSED    (0)

// LEDs
#define MICROPY_HW_LED1             (pin_B3)    // red JMOD
